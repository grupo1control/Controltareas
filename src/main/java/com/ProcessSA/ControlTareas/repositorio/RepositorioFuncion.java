 ...
 *   public interface RepositorioFuncion implements JpaRepository<[Clase], [tipoDatoID]>(){ }
 */
/**
 * Clase para definir las operaciones de BD relacionadas con FUNCION
 */
@Repository
public class RepositorioFuncion {
    ...
    public RepositorioFuncion(EntityManager gestorDeEntidad) {
        this.gestorDeEntidad = gestorDeEntidad;
    }

    /**
     * Ejecuta el procedimiento almacenado SP_GET_FUNCIONES,
     * para obetener una lista de todos los registros de Funcion,
     * y devuelve un objeto ArrayList con los resultados obtenidos
     *
     * @return
     */
    public ArrayList spGetFunciones() {
        StoredProcedureQuery consultaProcedimiento = gestorDeEntidad.createStoredProcedureQuery("SP_GET_FUNCIONES");
        ...
        consultaProcedimiento.registerStoredProcedureParameter("OUT_FUNCIONES", void.class, ParameterMode.REF_CURSOR);
     ...
     * retonando una lista de objetos de Funcion
     *
     * @param rs
     * @return
     */
    ...
    /**
     * Ejecuta el procedimiento almacenado SP_GET_FUNCION,
     * para obtener los datos de una Funcion,
     * y devuelve un objeto ArrayList con los resultados obtenidos
     *
     * @return
     */
    public ArrayList spGetFuncion(Long codigo) {
        ...
        consultaProcedimiento.registerStoredProcedureParameter("OUT_GLOSA", String.class, ParameterMode.OUT);
        consultaProcedimiento.registerStoredProcedureParameter("OUT_ESTADO", int.class, ParameterMode.OUT);
        consultaProcedimiento.registerStoredProcedureParameter("OUT_FUNCION", void.class, ParameterMode.REF_CURSOR);
    ...
    /**
     * Ejecuta el procedimiento almacenado SP_DEL_FUNCION,
     * para eliminar un registro de Funcion,
     * y retorna un objeto ArrayList con los resultados obtenidos
     * @param codigo
     * @return
     */
    public ArrayList spDelFuncion(Long codigo) {
    ...
    /**
     * Ejecuta el procedimiento almacenado SP_REG_FUNCION,
     * para ingresar o actualizar un registro de Funcion,
     ...
     * @return
     */
    public ArrayList spRegFuncion(Long codigo, String nombre, String descripcion, String inputEstado) {
        StoredProcedureQuery consultaProcedimiento = gestorDeEntidad.createStoredProcedureQuery("SP_REG_FUNCION");
        // Registrar los parámetros de entrada y salida
        consultaProcedimiento.registerStoredProcedureParameter("IN_CODIGO", Long.class, ParameterMode.IN);
